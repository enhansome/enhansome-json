...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,768 | 🐛 106 | 📅 2026-09-02 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,564 | 🐛 100 | 📅 2026-06-19
...
* [JSONExport](https://github.com/Ahmed-Ali/JSONExport) ⭐ 4,805 | 🐛 54 | 🌐 Swift | 📅 2023-10-22 - convert a object to a class of one of the currently supported languages.
...
* [JSON Formatter](https://chromewebstore.google.com/detail/json-formatter/bcjindcccaagfpapjjmafapmmgkkhgoa) ([github](https://github.com/callumlocke/json-formatter) ⭐ 4,129 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-26) - Makes JSON easy to read. Open source.
...
* [JSONView](https://addons.mozilla.org/en-US/firefox/addon/jsonview/) ([github](https://github.com/bhollis/jsonview) ⭐ 1,716 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-26) - View JSON documents in the browser.
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,545 | 🐛 477 | 🌐 C | 📅 2026-09-01 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,796 | 🐛 19 | 🌐 Go | 📅 2026-08-23 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,742 | 🐛 22 | 🌐 Rust | 📅 2026-08-28 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,619 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - A interactive terminal tool.
...
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,261 | 🐛 80 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet-like tool for interactively exploring data.
...
* [jid](https://github.com/simeji/jid) ⭐ 7,135 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - Incremental Digger. Drill down JSON interactively by using filtering queries like jq.
...
* [logdy](https://github.com/logdyhq/logdy-core) ⭐ 2,285 | 🐛 36 | 🌐 Go | 📅 2025-08-25 - jq, tail, less, grep and awk merged together and available in a clean web UI.
* [jsawk](https://github.com/micha/jsawk) ⭐ 1,385 | 🐛 28 | 🌐 Shell | 📅 2021-08-31 - Like awk, but for JSON.
* [oj](https://github.com/ohler55/ojg) ⭐ 955 | 🐛 0 | 🌐 Go | 📅 2026-08-22 - A fast and flexible command line JSON processor.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,372 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-03 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
* [lowdb](https://github.com/typicode/lowdb) ⭐ 22,575 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-27 - Flat file database built on lodash API. (Javascript)
* [Kinto](https://github.com/Kinto/kinto) ⭐ 4,417 | 🐛 104 | 🌐 Python | 📅 2026-09-03 - A lightweight JSON storage service with synchronisation and sharing abilities.
...
* [EJDB](https://github.com/Softmotions/ejdb) ⭐ 1,481 | 🐛 35 | 🌐 C | 📅 2026-08-30 - Embedded JSON Database engine published under MIT license. (C)
...
* [JSONModel](https://github.com/jsonmodel/jsonmodel) ⭐ 6,807 | 🐛 34 | 🌐 Objective-C | 📅 2021-11-06 - Magical Data Modelling Framework. (Objective-C)
...
* [jsondiffpatch](https://github.com/benjamine/jsondiffpatch) ⭐ 5,340 | 🐛 55 | 🌐 TypeScript | 📅 2026-05-14 - Diff & patch for JavaScript objects. (Javascript)
...
* [NDJSON](https://github.com/ndjson/ndjson-spec) ⭐ 848 | 🐛 17 | 📅 2022-10-20 (Newline delimited JSON) - a standard for delimiting JSON in stream protocols.
...
* [@textea/json-viewer](https://github.com/TexteaInc/json-viewer) ⭐ 534 | 🐛 27 | 🌐 TypeScript | 📅 2025-07-04 - A React component for JSON viewer. (React)
...
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,360 | 🐛 128 | 🌐 C | 📅 2026-07-09 - A C library for encoding, decoding and manipulating data.
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,530 | 🐛 144 | 🌐 C++ | 📅 2026-09-03 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,235 | 🐛 132 | 🌐 C++ | 📅 2026-09-03 - Parsing gigabytes of JSON per second.
* [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,121 | 🐛 792 | 🌐 C++ | 📅 2025-02-05 - A fast JSON parser/generator for C++ with both SAX/DOM style API
* [ArduinoJson](https://github.com/bblanchon/ArduinoJson) ⭐ 7,209 | 🐛 17 | 🌐 C++ | 📅 2026-08-15 - An efficient library for embedded systems.
...
* [ojg](https://github.com/ohler55/ojg) ⭐ 955 | 🐛 0 | 🌐 Go | 📅 2026-08-22 - A collection of high performance JSON processing and generating tool.
...
* [Gson](https://github.com/google/gson) ⭐ 24,233 | 🐛 344 | 🌐 Java | 📅 2026-09-01 - A Java library to convert JSON to Java objects and vice-versa.
...
* [dsl-json](https://github.com/ngs-doo/dsl-json) ⭐ 1,072 | 🐛 49 | 🌐 Java | 📅 2026-06-29 - A very fast streaming JSON library. Operates on byte arrays.
...
* [JSONKit](https://github.com/johnezang/JSONKit) ⭐ 6,175 | 🐛 103 | 🌐 Objective-C | 📅 2020-11-22 - Objective-C library.
...
* [simplejson](https://github.com/simplejson/simplejson) ⭐ 1,710 | 🐛 14 | 🌐 Python | 📅 2026-08-29 - A simple, fast, extensible encoder/decoder
...
* [oj](https://github.com/ohler55/oj) ⭐ 3,225 | 🐛 14 | 🌐 C | 📅 2026-08-30 - A fast JSON parser and Object marshaller as a Ruby gem.
...
* [circe](https://github.com/circe/circe) ⭐ 2,541 | 🐛 128 | 🌐 Scala | 📅 2026-07-23 - Yet another JSON library for Scala.
...
* [jsoniter-scala](https://github.com/plokhotnyuk/jsoniter-scala) ⭐ 819 | 🐛 98 | 🌐 Scala | 📅 2026-09-02 - Scala macros for compile-time generation of ultra-fast JSON codecs.
...
* [SwiftyJSON](https://github.com/SwiftyJSON/SwiftyJSON) ⭐ 22,949 | 🐛 139 | 🌐 Swift | 📅 2026-08-18 - The better way to deal with data in Swift.

* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,860 | 🐛 41 | 🌐 C | 📅 2026-08-26 - High performance parser and serializer in C.
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 3 | 🌐 C | 📅 2026-09-02 - A lightweight featureful DSL for data modeling.
...
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,601 | 🐛 8 | 📅 2026-09-02 - A minimal configuration file format that's easy to read due to obvious semantics.
...
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,802 | 🐛 237 | 🌐 Go | 📅 2026-08-27 - A structured configuration language that is both human and machine friendly.
...
* [Awesome jq](https://github.com/fiatjaf/awesome-jq) ⭐ 976 | 🐛 5 | 📅 2026-08-17 - A curated list of awesome jq tools and resources.
...
* [JSON Parsing Test Suite](https://github.com/nst/JSONTestSuite) ⭐ 1,166 | 🐛 53 | 🌐 C++ | 📅 2024-11-22 - A very complete test suite and validation framework.
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 1,004 | 🐛 15 | 🌐 Java | 📅 2026-09-04 - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,137 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-03 - Fast XML to JSON and vice versa javascript/JSON conversion.
...
* [jsonschema2pojo](https://github.com/joelittlejohn/jsonschema2pojo) ⭐ 6,382 | 🐛 250 | 🌐 Java | 📅 2026-05-02 - Generates Java types and annotates those types for data-binding with Jackson 1.x or 2.x, Gson, etc.
...
* [JSON Schema $Ref Parser](https://github.com/APIDevTools/json-schema-ref-parser) ⭐ 1,115 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-26 - Parse, resolve, and dereference JSON Schema $ref pointers
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 302 | 🐛 30 | 🌐 C++ | 📅 2026-09-02 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,820 | 🐛 376 | 🌐 TypeScript | 📅 2026-05-12 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [JSON Schema for PHP](https://github.com/justinrainbow/json-schema) ⭐ 3,632 | 🐛 21 | 🌐 PHP | 📅 2026-09-01 - PHP implementation of JSON schema.
* [JSON Guard](https://json-guard.thephpleague.com) - A validator for JSON Schema Draft 4.

**Python**

* [jsonschema](https://github.com/python-jsonschema/jsonschema) ⭐ 4,979 | 🐛 59 | 🌐 Python | 📅 2026-09-01 - Python implementation of jsonschema.
...
* [Ruby JSON Schema Validator](https://github.com/voxpupuli/json-schema) ⭐ 1,644 | 🐛 105 | 🌐 Ruby | 📅 2026-07-05 - validating against a JSON schema conforming to JSON Schema Draft 4.
