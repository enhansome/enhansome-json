...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,734 | 🐛 106 | 📅 2026-09-02 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,564 | 🐛 103 | 📅 2026-06-19
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,558 | 🐛 478 | 🌐 C | 📅 2026-09-01 - A lightweight and flexible command-line JSON processor.
...
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,264 | 🐛 82 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet-like tool for interactively exploring data.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,373 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-04 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,558 | 🐛 159 | 🌐 C++ | 📅 2026-09-07 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,239 | 🐛 133 | 🌐 C++ | 📅 2026-09-06 - Parsing gigabytes of JSON per second.
* [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,123 | 🐛 792 | 🌐 C++ | 📅 2025-02-05 - A fast JSON parser/generator for C++ with both SAX/DOM style API
...
* [Gson](https://github.com/google/gson) ⭐ 24,234 | 🐛 348 | 🌐 Java | 📅 2026-09-01 - A Java library to convert JSON to Java objects and vice-versa.
* [moshi](https://github.com/square/moshi) ⭐ 10,160 | 🐛 114 | 🌐 Kotlin | 📅 2026-09-04 - A modern JSON library for Android and Java.
* [Jackson](https://github.com/FasterXML/jackson) ⭐ 9,804 | 🐛 0 | 📅 2026-09-04 - A multi-purpose Java library for processing JSON data format.
...
* [oj](https://github.com/ohler55/oj) ⭐ 3,225 | 🐛 14 | 🌐 C | 📅 2026-09-06 - A fast JSON parser and Object marshaller as a Ruby gem.
...
* [jsoniter-scala](https://github.com/plokhotnyuk/jsoniter-scala) ⭐ 819 | 🐛 98 | 🌐 Scala | 📅 2026-09-06 - Scala macros for compile-time generation of ultra-fast JSON codecs.
...
* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,863 | 🐛 39 | 🌐 C | 📅 2026-09-06 - High performance parser and serializer in C.
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 3 | 🌐 C | 📅 2026-09-06 - A lightweight featureful DSL for data modeling.
...
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,806 | 🐛 237 | 🌐 Go | 📅 2026-08-27 - A structured configuration language that is both human and machine friendly.
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 304 | 🐛 32 | 🌐 C++ | 📅 2026-09-06 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,822 | 🐛 377 | 🌐 TypeScript | 📅 2026-09-06 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [JSON Schema for PHP](https://github.com/justinrainbow/json-schema) ⭐ 3,632 | 🐛 18 | 🌐 PHP | 📅 2026-09-06 - PHP implementation of JSON schema.
* [JSON Guard](https://json-guard.thephpleague.com) - A validator for JSON Schema Draft 4.

**Python**

* [jsonschema](https://github.com/python-jsonschema/jsonschema) ⭐ 4,977 | 🐛 56 | 🌐 Python | 📅 2026-09-06 - Python implementation of jsonschema.
