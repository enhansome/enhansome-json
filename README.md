...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,050 | 🐛 100 | 📅 2026-06-30 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,561 | 🐛 74 | 📅 2026-06-19
...
* [JSONExport](https://github.com/Ahmed-Ali/JSONExport) ⭐ 4,808 | 🐛 54 | 🌐 Swift | 📅 2023-10-22 - convert a object to a class of one of the currently supported languages.
...
* [JSON Formatter](https://chromewebstore.google.com/detail/json-formatter/bcjindcccaagfpapjjmafapmmgkkhgoa) ([github](https://github.com/callumlocke/json-formatter) ⭐ 4,127 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-26) - Makes JSON easy to read. Open source.
...
* [JSON Viewer Pro](https://chromewebstore.google.com/detail/json-viewer-pro/eifflpmocdbdmepbjaopkkhbfmdgijcc) ([github](https://github.com/rbrahul/Awesome-JSON-Viewer) ⭐ 582 | 🐛 19 | 🌐 JavaScript | 📅 2026-01-30 - An open source Chrome extension for browsing JSON with syntax highlighting and folding, or as a visual graph.
...
* [JSONView](https://addons.mozilla.org/en-US/firefox/addon/jsonview/) ([github](https://github.com/bhollis/jsonview) ⭐ 1,708 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-26) - View JSON documents in the browser.
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,441 | 🐛 472 | 🌐 C | 📅 2026-08-12 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,793 | 🐛 13 | 🌐 Go | 📅 2026-07-20 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,705 | 🐛 22 | 🌐 Rust | 📅 2026-08-07 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,578 | 🐛 24 | 🌐 Go | 📅 2026-07-28 - A interactive terminal tool.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,500 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - Convert a JSON file into discrete assignments that are greppable.
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,238 | 🐛 71 | 🌐 Python | 📅 2026-08-04 - A terminal spreadsheet-like tool for interactively exploring data.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,663 | 🐛 49 | 🌐 Python | 📅 2026-06-18 - Converts the output of many CLI tools, file-types, and common strings into JSON
* [jid](https://github.com/simeji/jid) ⭐ 7,133 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - Incremental Digger. Drill down JSON interactively by using filtering queries like jq.
* [jo](https://github.com/jpmens/jo) ⭐ 4,864 | 🐛 7 | 🌐 C | 📅 2025-06-20 - A small utility to create JSON objects
* [dsq](https://github.com/multiprocessio/dsq) ⭐ 3,867 | 🐛 22 | 🌐 Go | 📅 2023-09-30 - Tool for running SQL queries against JSON, CSV, Excel, Parquet, and more.
* [logdy](https://github.com/logdyhq/logdy-core) ⭐ 2,265 | 🐛 36 | 🌐 Go | 📅 2025-08-25 - jq, tail, less, grep and awk merged together and available in a clean web UI.
* [jsawk](https://github.com/micha/jsawk) ⭐ 1,385 | 🐛 28 | 🌐 Shell | 📅 2021-08-31 - Like awk, but for JSON.
* [oj](https://github.com/ohler55/ojg) ⭐ 953 | 🐛 0 | 🌐 Go | 📅 2026-08-08 - A fast and flexible command line JSON processor.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,335 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-13 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
* [lowdb](https://github.com/typicode/lowdb) ⭐ 22,572 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-27 - Flat file database built on lodash API. (Javascript)
* [Kinto](https://github.com/Kinto/kinto) ⭐ 4,417 | 🐛 94 | 🌐 Python | 📅 2026-08-10 - A lightweight JSON storage service with synchronisation and sharing abilities.
...
* [EJDB](https://github.com/Softmotions/ejdb) ⭐ 1,478 | 🐛 35 | 🌐 C | 📅 2026-08-08 - Embedded JSON Database engine published under MIT license. (C)
...
* [countries](https://github.com/mledoze/countries) ⭐ 6,251 | 🐛 17 | 🌐 PHP | 📅 2026-07-20 - World countries.
...
* [jsondiffpatch](https://github.com/benjamine/jsondiffpatch) ⭐ 5,333 | 🐛 55 | 🌐 TypeScript | 📅 2026-05-14 - Diff & patch for JavaScript objects. (Javascript)
* [JSON-Patch](https://github.com/Starcounter-Jack/JSON-Patch) ⭐ 1,980 | 🐛 82 | 🌐 JavaScript | 📅 2025-10-23 - Lean and mean Javascript implementation of the JSON-Patch standard (RFC 6902). (Javascript)
...
* [Dynatable.js](https://github.com/alfajango/jquery-dynatable) ⭐ 2,752 | 🐛 228 | 🌐 JavaScript | 📅 2022-02-25 - A funner, semantic, HTML5+JSON, interactive table plugin. (jQuery)

* [JSON editor jQuery plugin](https://github.com/DavidDurman/FlexiJsonEditor) ⭐ 565 | 🐛 19 | 🌐 JavaScript | 📅 2019-02-05 - component for you web apps/pages. (jQuery)
...
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,355 | 🐛 127 | 🌐 C | 📅 2026-07-09 - A C library for encoding, decoding and manipulating data.
* [json-build](https://github.com/lcsmuller/json-build) ⭐ 51 | 🐛 0 | 🌐 C | 📅 2025-04-12 - A minimalistic serializer in C. It can be easily integrated into the resource-limited projects or embedded systems.
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,358 | 🐛 96 | 🌐 C++ | 📅 2026-08-12 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,149 | 🐛 135 | 🌐 C++ | 📅 2026-08-12 - Parsing gigabytes of JSON per second.
* [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,111 | 🐛 788 | 🌐 C++ | 📅 2025-02-05 - A fast JSON parser/generator for C++ with both SAX/DOM style API
* [ArduinoJson](https://github.com/bblanchon/ArduinoJson) ⭐ 7,202 | 🐛 17 | 🌐 C++ | 📅 2026-08-11 - An efficient library for embedded systems.
...
* [data.json](https://github.com/clojure/data.json) ⭐ 577 | 🐛 2 | 🌐 Clojure | 📅 2026-01-02 - parser/generator to/from Clojure data structures.
...
* [ojg](https://github.com/ohler55/ojg) ⭐ 953 | 🐛 0 | 🌐 Go | 📅 2026-08-08 - A collection of high performance JSON processing and generating tool.
...
* [Gson](https://github.com/google/gson) ⭐ 24,234 | 🐛 340 | 🌐 Java | 📅 2026-08-11 - A Java library to convert JSON to Java objects and vice-versa.
...
* [JSON-java](https://github.com/stleary/JSON-java) ⭐ 4,717 | 🐛 23 | 🌐 Java | 📅 2026-07-31 - A reference implementation.
...
* [JSON-js](https://github.com/douglascrockford/JSON-js) ⭐ 8,719 | 🐛 0 | 🌐 JavaScript | 📅 2023-05-10 - JSON in JavaScript.
...
* [simplejson](https://github.com/simplejson/simplejson) ⭐ 1,712 | 🐛 13 | 🌐 Python | 📅 2026-08-06 - A simple, fast, extensible encoder/decoder
...
* [oj](https://github.com/ohler55/oj) ⭐ 3,225 | 🐛 13 | 🌐 C | 📅 2026-08-10 - A fast JSON parser and Object marshaller as a Ruby gem.
* [MultiJSON](https://github.com/intridea/multi_json) ⭐ 764 | 🐛 2 | 🌐 Ruby | 📅 2025-06-24 - A generic swappable back-end for JSON handling.
...
* [jsonfx](https://github.com/jsonfx/jsonfx) ⭐ 379 | 🐛 20 | 🌐 C# | 📅 2016-12-24 - serialization framework for .NET.
...
* [circe](https://github.com/circe/circe) ⭐ 2,541 | 🐛 127 | 🌐 Scala | 📅 2026-07-23 - Yet another JSON library for Scala.
...
* [jsoniter-scala](https://github.com/plokhotnyuk/jsoniter-scala) ⭐ 819 | 🐛 98 | 🌐 Scala | 📅 2026-08-11 - Scala macros for compile-time generation of ultra-fast JSON codecs.
...
* [SwiftyJSON](https://github.com/SwiftyJSON/SwiftyJSON) ⭐ 22,951 | 🐛 139 | 🌐 Swift | 📅 2026-03-04 - The better way to deal with data in Swift.

* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,834 | 🐛 39 | 🌐 C | 📅 2026-07-22 - High performance parser and serializer in C.

## Linters

* [jsonlint](https://github.com/zaach/jsonlint) ⭐ 1,992 | 🐛 83 | 🌐 JavaScript | 📅 2022-07-12 - Parser and validator with a CLI. (Javascript)
* [JSON Lint](https://github.com/Seldaek/jsonlint) ⭐ 1,324 | 🐛 1 | 🌐 PHP | 📅 2026-08-01 - PHP linter. (PHP)
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 2 | 🌐 C | 📅 2026-08-12 - A lightweight featureful DSL for data modeling.
...
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,566 | 🐛 15 | 📅 2026-07-03 - A minimal configuration file format that's easy to read due to obvious semantics.
* [HOCON](https://github.com/lightbend/config/blob/master/HOCON.md) ⭐ 6,312 | 🐛 242 | 🌐 Java | 📅 2026-07-01 - Human-Optimized Config Object Notation.
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,803 | 🐛 236 | 🌐 Go | 📅 2026-08-12 - A structured configuration language that is both human and machine friendly.
...
* [Awesome jq](https://github.com/fiatjaf/awesome-jq) ⭐ 973 | 🐛 5 | 📅 2026-02-24 - A curated list of awesome jq tools and resources.
...
* [rabl](https://github.com/nesquena/rabl) ⭐ 3,634 | 🐛 123 | 🌐 Ruby | 📅 2026-03-18 - General ruby templating with json, bson, xml, plist and msgpack support. (Ruby)
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 1,003 | 🐛 16 | 🌐 Java | 📅 2026-08-12 - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [nvim-jqx](https://github.com/gennaro-tedesco/nvim-jqx) ⭐ 338 | 🐛 2 | 🌐 Lua | 📅 2024-05-31 - Browse and query json files in neovim from the quickfix window. (Lua)

## Transformations

* [normalizr](https://github.com/paularmstrong/normalizr) ⚠️ Archived - Normalizes nested JSON according to a schema. (Javascript)
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,130 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-10 - Fast XML to JSON and vice versa javascript/JSON conversion.
* [JsonMapper](https://github.com/cweiske/jsonmapper) ⭐ 1,575 | 🐛 2 | 🌐 PHP | 📅 2026-06-30 - Map nested structures onto PHP classes (PHP)
...
* [JSONC](https://github.com/tcorral/JSONC) ⭐ 653 | 🐛 22 | 🌐 JavaScript | 📅 2018-12-11 - JSON compressor and decompressor. (Javascript)
...
* [JSON Editor](https://github.com/jdorn/json-editor) ⭐ 5,819 | 🐛 455 | 🌐 JavaScript | 📅 2018-04-18 - JSON Schema Based Editor. (jQuery)
...
* [jsonschema2pojo](https://github.com/joelittlejohn/jsonschema2pojo) ⭐ 6,378 | 🐛 251 | 🌐 Java | 📅 2026-05-02 - Generates Java types and annotates those types for data-binding with Jackson 1.x or 2.x, Gson, etc.
* [JSON Schema + Faker](https://github.com/json-schema-faker/json-schema-faker) ⭐ 3,447 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-01 - Fake your schemas.
* [prmd](https://github.com/interagent/prmd) ⭐ 2,092 | 🐛 75 | 🌐 Ruby | 📅 2025-02-06 - Tools and doc generation for HTTP APIs.
* [JSON Schema $Ref Parser](https://github.com/APIDevTools/json-schema-ref-parser) ⭐ 1,112 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-30 - Parse, resolve, and dereference JSON Schema $ref pointers
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 292 | 🐛 27 | 🌐 C++ | 📅 2026-08-12 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [Awesome JSON Schema](https://github.com/sourcemeta/awesome-jsonschema) ⭐ 169 | 🐛 12 | 🌐 Handlebars | 📅 2026-05-12 - A curated list of awesome JSON Schema resources, tutorials, tools, and more.

## JSON Schema Validators

**Javascript and Node.js**

* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,802 | 🐛 373 | 🌐 TypeScript | 📅 2026-05-12 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [z-schema](https://github.com/zaggino/z-schema) ⭐ 350 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-12 - validator written in JavaScript for NodeJS and Browsers.
...
* [JSON Schema for PHP](https://github.com/justinrainbow/json-schema) ⭐ 3,627 | 🐛 21 | 🌐 PHP | 📅 2026-07-24 - PHP implementation of JSON schema.
* [JSON Guard](https://json-guard.thephpleague.com) - A validator for JSON Schema Draft 4.

**Python**

* [jsonschema](https://github.com/python-jsonschema/jsonschema) ⭐ 4,968 | 🐛 68 | 🌐 Python | 📅 2026-08-10 - Python implementation of jsonschema.
...
* [Ruby JSON Schema Validator](https://github.com/voxpupuli/json-schema) ⭐ 1,645 | 🐛 105 | 🌐 Ruby | 📅 2026-07-05 - validating against a JSON schema conforming to JSON Schema Draft 4.
