...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,218 | 🐛 106 | 📅 2026-09-02 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,564 | 🐛 107 | 📅 2026-06-19
...
* [JSONView](https://addons.mozilla.org/en-US/firefox/addon/jsonview/) ([github](https://github.com/bhollis/jsonview) ⭐ 1,718 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-26) - View JSON documents in the browser.
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,587 | 🐛 480 | 🌐 C | 📅 2026-09-01 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,803 | 🐛 19 | 🌐 Go | 📅 2026-09-04 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,749 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,623 | 🐛 30 | 🌐 Go | 📅 2026-08-26 - A interactive terminal tool.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,516 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - Convert a JSON file into discrete assignments that are greppable.
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,274 | 🐛 88 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet-like tool for interactively exploring data.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,673 | 🐛 42 | 🌐 Python | 📅 2026-09-10 - Converts the output of many CLI tools, file-types, and common strings into JSON
...
* [oj](https://github.com/ohler55/ojg) ⭐ 954 | 🐛 4 | 🌐 Go | 📅 2026-09-10 - A fast and flexible command line JSON processor.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,377 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-12 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
...
* [countries](https://github.com/mledoze/countries) ⭐ 6,258 | 🐛 17 | 🌐 PHP | 📅 2026-09-03 - World countries.
...
* [JSON6](https://github.com/d3x0r/json6) ⭐ 241 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-12 - JSON for Humans (ES6).
...
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,364 | 🐛 133 | 🌐 C | 📅 2026-07-09 - A C library for encoding, decoding and manipulating data.
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,587 | 🐛 117 | 🌐 C++ | 📅 2026-09-11 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,246 | 🐛 135 | 🌐 C++ | 📅 2026-09-07 - Parsing gigabytes of JSON per second.
* [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,122 | 🐛 794 | 🌐 C++ | 📅 2025-02-05 - A fast JSON parser/generator for C++ with both SAX/DOM style API
* [ArduinoJson](https://github.com/bblanchon/ArduinoJson) ⭐ 7,214 | 🐛 16 | 🌐 C++ | 📅 2026-08-15 - An efficient library for embedded systems.
...
* [ojg](https://github.com/ohler55/ojg) ⭐ 954 | 🐛 4 | 🌐 Go | 📅 2026-09-10 - A collection of high performance JSON processing and generating tool.
...
* [Gson](https://github.com/google/gson) ⭐ 24,237 | 🐛 346 | 🌐 Java | 📅 2026-09-09 - A Java library to convert JSON to Java objects and vice-versa.
* [moshi](https://github.com/square/moshi) ⭐ 10,163 | 🐛 115 | 🌐 Kotlin | 📅 2026-09-09 - A modern JSON library for Android and Java.
...
* [JSON-java](https://github.com/stleary/JSON-java) ⭐ 4,717 | 🐛 23 | 🌐 Java | 📅 2026-08-24 - A reference implementation.
...
* [simplejson](https://github.com/simplejson/simplejson) ⭐ 1,710 | 🐛 16 | 🌐 Python | 📅 2026-08-29 - A simple, fast, extensible encoder/decoder
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 2 | 🌐 C | 📅 2026-09-11 - A lightweight featureful DSL for data modeling.
...
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,611 | 🐛 6 | 📅 2026-09-11 - A minimal configuration file format that's easy to read due to obvious semantics.
...
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,807 | 🐛 234 | 🌐 Go | 📅 2026-09-11 - A structured configuration language that is both human and machine friendly.
...
* [JSON Parsing Test Suite](https://github.com/nst/JSONTestSuite) ⭐ 1,169 | 🐛 53 | 🌐 C++ | 📅 2024-11-22 - A very complete test suite and validation framework.
...
* [JSON Schema + Faker](https://github.com/json-schema-faker/json-schema-faker) ⭐ 3,448 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-01 - Fake your schemas.
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 305 | 🐛 28 | 🌐 C++ | 📅 2026-09-11 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [JSON Schema for PHP](https://github.com/justinrainbow/json-schema) ⭐ 3,632 | 🐛 19 | 🌐 PHP | 📅 2026-09-09 - PHP implementation of JSON schema.
* [JSON Guard](https://json-guard.thephpleague.com) - A validator for JSON Schema Draft 4.

**Python**

* [jsonschema](https://github.com/python-jsonschema/jsonschema) ⭐ 4,978 | 🐛 53 | 🌐 Python | 📅 2026-09-07 - Python implementation of jsonschema.
