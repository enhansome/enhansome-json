...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,468 | 🐛 105 | 📅 2026-09-02 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,564 | 🐛 98 | 📅 2026-06-19
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,537 | 🐛 475 | 🌐 C | 📅 2026-09-01 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,796 | 🐛 18 | 🌐 Go | 📅 2026-08-23 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,741 | 🐛 22 | 🌐 Rust | 📅 2026-08-28 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,617 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - A interactive terminal tool.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,502 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - Convert a JSON file into discrete assignments that are greppable.
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,263 | 🐛 80 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet-like tool for interactively exploring data.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,372 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-03 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
* [lowdb](https://github.com/typicode/lowdb) ⭐ 22,576 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-27 - Flat file database built on lodash API. (Javascript)
* [Kinto](https://github.com/Kinto/kinto) ⭐ 4,417 | 🐛 94 | 🌐 Python | 📅 2026-09-02 - A lightweight JSON storage service with synchronisation and sharing abilities.
...
* [EJDB](https://github.com/Softmotions/ejdb) ⭐ 1,480 | 🐛 35 | 🌐 C | 📅 2026-08-30 - Embedded JSON Database engine published under MIT license. (C)
...
* [countries](https://github.com/mledoze/countries) ⭐ 6,256 | 🐛 17 | 🌐 PHP | 📅 2026-07-20 - World countries.
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,513 | 🐛 144 | 🌐 C++ | 📅 2026-09-03 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,231 | 🐛 132 | 🌐 C++ | 📅 2026-09-01 - Parsing gigabytes of JSON per second.
* [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,120 | 🐛 791 | 🌐 C++ | 📅 2025-02-05 - A fast JSON parser/generator for C++ with both SAX/DOM style API
* [ArduinoJson](https://github.com/bblanchon/ArduinoJson) ⭐ 7,208 | 🐛 17 | 🌐 C++ | 📅 2026-08-15 - An efficient library for embedded systems.
...
* [Gson](https://github.com/google/gson) ⭐ 24,230 | 🐛 343 | 🌐 Java | 📅 2026-09-01 - A Java library to convert JSON to Java objects and vice-versa.
...
* [circe](https://github.com/circe/circe) ⭐ 2,542 | 🐛 128 | 🌐 Scala | 📅 2026-07-23 - Yet another JSON library for Scala.
...
* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,859 | 🐛 42 | 🌐 C | 📅 2026-08-26 - High performance parser and serializer in C.
...
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,602 | 🐛 8 | 📅 2026-09-02 - A minimal configuration file format that's easy to read due to obvious semantics.
...
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,801 | 🐛 236 | 🌐 Go | 📅 2026-08-27 - A structured configuration language that is both human and machine friendly.
...
* [rabl](https://github.com/nesquena/rabl) ⭐ 3,629 | 🐛 122 | 🌐 Ruby | 📅 2026-03-18 - General ruby templating with json, bson, xml, plist and msgpack support. (Ruby)
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 1,004 | 🐛 14 | 🌐 Java | 📅 2026-09-03 - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,137 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-03 - Fast XML to JSON and vice versa javascript/JSON conversion.
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 302 | 🐛 29 | 🌐 C++ | 📅 2026-09-02 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,819 | 🐛 376 | 🌐 TypeScript | 📅 2026-05-12 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [z-schema](https://github.com/zaggino/z-schema) ⭐ 350 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02 - validator written in JavaScript for NodeJS and Browsers.
