...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,904 | 🐛 106 | 📅 2026-09-02 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,564 | 🐛 106 | 📅 2026-06-19
...
* [JSONExport](https://github.com/Ahmed-Ali/JSONExport) ⭐ 4,800 | 🐛 54 | 🌐 Swift | 📅 2023-10-22 - convert a object to a class of one of the currently supported languages.
...
* [JSON Formatter](https://chromewebstore.google.com/detail/json-formatter/bcjindcccaagfpapjjmafapmmgkkhgoa) ([github](https://github.com/callumlocke/json-formatter) ⭐ 4,130 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-04) - Makes JSON easy to read. Open source.
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,577 | 🐛 480 | 🌐 C | 📅 2026-09-01 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,803 | 🐛 19 | 🌐 Go | 📅 2026-09-04 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,748 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,622 | 🐛 30 | 🌐 Go | 📅 2026-08-26 - A interactive terminal tool.
...
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,273 | 🐛 88 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet-like tool for interactively exploring data.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,673 | 🐛 41 | 🌐 Python | 📅 2026-09-10 - Converts the output of many CLI tools, file-types, and common strings into JSON
...
* [oj](https://github.com/ohler55/ojg) ⭐ 954 | 🐛 1 | 🌐 Go | 📅 2026-09-10 - A fast and flexible command line JSON processor.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,376 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-11 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
* [lowdb](https://github.com/typicode/lowdb) ⭐ 22,577 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-27 - Flat file database built on lodash API. (Javascript)
* [Kinto](https://github.com/Kinto/kinto) ⭐ 4,416 | 🐛 96 | 🌐 Python | 📅 2026-09-10 - A lightweight JSON storage service with synchronisation and sharing abilities.
...
* [EJDB](https://github.com/Softmotions/ejdb) ⭐ 1,480 | 🐛 35 | 🌐 C | 📅 2026-09-10 - Embedded JSON Database engine published under MIT license. (C)
...
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,364 | 🐛 129 | 🌐 C | 📅 2026-07-09 - A C library for encoding, decoding and manipulating data.
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,581 | 🐛 136 | 🌐 C++ | 📅 2026-09-10 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,246 | 🐛 135 | 🌐 C++ | 📅 2026-09-07 - Parsing gigabytes of JSON per second.
* [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,126 | 🐛 794 | 🌐 C++ | 📅 2025-02-05 - A fast JSON parser/generator for C++ with both SAX/DOM style API
* [ArduinoJson](https://github.com/bblanchon/ArduinoJson) ⭐ 7,212 | 🐛 17 | 🌐 C++ | 📅 2026-08-15 - An efficient library for embedded systems.
...
* [JSON-Fortran](https://github.com/jacobwilliams/json-fortran) ⭐ 382 | 🐛 26 | 🌐 Fortran | 📅 2026-06-11 - A Fortran library for writing, reading, and manipulating JSON files and data structures.

**Go**

* [ojg](https://github.com/ohler55/ojg) ⭐ 954 | 🐛 1 | 🌐 Go | 📅 2026-09-10 - A collection of high performance JSON processing and generating tool.
...
* [Gson](https://github.com/google/gson) ⭐ 24,236 | 🐛 346 | 🌐 Java | 📅 2026-09-09 - A Java library to convert JSON to Java objects and vice-versa.
...
* [oj](https://github.com/ohler55/oj) ⭐ 3,225 | 🐛 14 | 🌐 C | 📅 2026-09-10 - A fast JSON parser and Object marshaller as a Ruby gem.
...
* [jsoniter-scala](https://github.com/plokhotnyuk/jsoniter-scala) ⭐ 819 | 🐛 98 | 🌐 Scala | 📅 2026-09-11 - Scala macros for compile-time generation of ultra-fast JSON codecs.
...
* [SwiftyJSON](https://github.com/SwiftyJSON/SwiftyJSON) ⭐ 22,946 | 🐛 139 | 🌐 Swift | 📅 2026-08-18 - The better way to deal with data in Swift.

* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,869 | 🐛 39 | 🌐 C | 📅 2026-09-08 - High performance parser and serializer in C.
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 2 | 🌐 C | 📅 2026-09-10 - A lightweight featureful DSL for data modeling.
...
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,610 | 🐛 6 | 📅 2026-09-10 - A minimal configuration file format that's easy to read due to obvious semantics.
* [HOCON](https://github.com/lightbend/config/blob/master/HOCON.md) ⭐ 6,315 | 🐛 243 | 🌐 Java | 📅 2026-07-01 - Human-Optimized Config Object Notation.
...
* [JSONassert](https://github.com/skyscreamer/JSONassert) ⭐ 1,058 | 🐛 94 | 🌐 Java | 📅 2024-07-28 - Write JSON unit tests in less code. Great for testing REST interfaces. (Java)
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 1,005 | 🐛 14 | 🌐 Java | 📅 2026-09-11 - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,138 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-10 - Fast XML to JSON and vice versa javascript/JSON conversion.
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 305 | 🐛 29 | 🌐 C++ | 📅 2026-09-10 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,825 | 🐛 377 | 🌐 TypeScript | 📅 2026-09-06 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [z-schema](https://github.com/zaggino/z-schema) ⭐ 350 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - validator written in JavaScript for NodeJS and Browsers.
