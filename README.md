...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,525 | 🐛 105 | 📅 2026-08-21 list.
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,520 | 🐛 474 | 🌐 C | 📅 2026-08-23 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,796 | 🐛 18 | 🌐 Go | 📅 2026-08-23 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,739 | 🐛 22 | 🌐 Rust | 📅 2026-08-28 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,611 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - A interactive terminal tool.
...
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,258 | 🐛 80 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet-like tool for interactively exploring data.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,371 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-27 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
* [lowdb](https://github.com/typicode/lowdb) ⭐ 22,577 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-27 - Flat file database built on lodash API. (Javascript)
* [Kinto](https://github.com/Kinto/kinto) ⭐ 4,418 | 🐛 95 | 🌐 Python | 📅 2026-08-27 - A lightweight JSON storage service with synchronisation and sharing abilities.
...
* [jsondiffpatch](https://github.com/benjamine/jsondiffpatch) ⭐ 5,338 | 🐛 55 | 🌐 TypeScript | 📅 2026-05-14 - Diff & patch for JavaScript objects. (Javascript)
...
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,359 | 🐛 128 | 🌐 C | 📅 2026-07-09 - A C library for encoding, decoding and manipulating data.
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,489 | 🐛 141 | 🌐 C++ | 📅 2026-08-30 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,216 | 🐛 134 | 🌐 C++ | 📅 2026-08-27 - Parsing gigabytes of JSON per second.
...
* [Gson](https://github.com/google/gson) ⭐ 24,228 | 🐛 340 | 🌐 Java | 📅 2026-08-27 - A Java library to convert JSON to Java objects and vice-versa.
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 3 | 🌐 C | 📅 2026-08-30 - A lightweight featureful DSL for data modeling.
...
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,596 | 🐛 8 | 📅 2026-08-30 - A minimal configuration file format that's easy to read due to obvious semantics.
...
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,799 | 🐛 236 | 🌐 Go | 📅 2026-08-27 - A structured configuration language that is both human and machine friendly.
...
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,135 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-27 - Fast XML to JSON and vice versa javascript/JSON conversion.
...
* [JSON Schema $Ref Parser](https://github.com/APIDevTools/json-schema-ref-parser) ⭐ 1,114 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-26 - Parse, resolve, and dereference JSON Schema $ref pointers
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 300 | 🐛 29 | 🌐 C++ | 📅 2026-08-27 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [JSON Schema for PHP](https://github.com/justinrainbow/json-schema) ⭐ 3,631 | 🐛 24 | 🌐 PHP | 📅 2026-08-21 - PHP implementation of JSON schema.
* [JSON Guard](https://json-guard.thephpleague.com) - A validator for JSON Schema Draft 4.

**Python**

* [jsonschema](https://github.com/python-jsonschema/jsonschema) ⭐ 4,979 | 🐛 61 | 🌐 Python | 📅 2026-08-27 - Python implementation of jsonschema.
