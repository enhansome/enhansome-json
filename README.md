...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,598 | 🐛 106 | 📅 2026-09-02 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,564 | 🐛 105 | 📅 2026-06-19
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,564 | 🐛 479 | 🌐 C | 📅 2026-09-01 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,802 | 🐛 18 | 🌐 Go | 📅 2026-09-04 - Pure Go implementation of jq. A bit faster and more portable.
...
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,514 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - Convert a JSON file into discrete assignments that are greppable.
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,267 | 🐛 83 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet-like tool for interactively exploring data.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,670 | 🐛 40 | 🌐 Python | 📅 2026-08-28 - Converts the output of many CLI tools, file-types, and common strings into JSON
* [jid](https://github.com/simeji/jid) ⭐ 7,139 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - Incremental Digger. Drill down JSON interactively by using filtering queries like jq.
...
* [logdy](https://github.com/logdyhq/logdy-core) ⭐ 2,288 | 🐛 37 | 🌐 Go | 📅 2025-08-25 - jq, tail, less, grep and awk merged together and available in a clean web UI.
* [jsawk](https://github.com/micha/jsawk) ⭐ 1,382 | 🐛 28 | 🌐 Shell | 📅 2021-08-31 - Like awk, but for JSON.
* [oj](https://github.com/ohler55/ojg) ⭐ 954 | 🐛 0 | 🌐 Go | 📅 2026-09-06 - A fast and flexible command line JSON processor.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,376 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-10 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
...
* [EJDB](https://github.com/Softmotions/ejdb) ⭐ 1,480 | 🐛 35 | 🌐 C | 📅 2026-09-09 - Embedded JSON Database engine published under MIT license. (C)
...
* [countries](https://github.com/mledoze/countries) ⭐ 6,257 | 🐛 17 | 🌐 PHP | 📅 2026-09-03 - World countries.
...
* [jsondiffpatch](https://github.com/benjamine/jsondiffpatch) ⭐ 5,339 | 🐛 54 | 🌐 TypeScript | 📅 2026-05-14 - Diff & patch for JavaScript objects. (Javascript)
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,576 | 🐛 139 | 🌐 C++ | 📅 2026-09-09 - A C++11 header-only class.
...
* [ojg](https://github.com/ohler55/ojg) ⭐ 954 | 🐛 0 | 🌐 Go | 📅 2026-09-06 - A collection of high performance JSON processing and generating tool.
...
* [Gson](https://github.com/google/gson) ⭐ 24,235 | 🐛 346 | 🌐 Java | 📅 2026-09-09 - A Java library to convert JSON to Java objects and vice-versa.
...
* [JSON-java](https://github.com/stleary/JSON-java) ⭐ 4,718 | 🐛 23 | 🌐 Java | 📅 2026-08-24 - A reference implementation.
* [dsl-json](https://github.com/ngs-doo/dsl-json) ⭐ 1,071 | 🐛 48 | 🌐 Java | 📅 2026-09-09 - A very fast streaming JSON library. Operates on byte arrays.
...
* [oboe.js](https://github.com/jimhigson/oboe.js) ⭐ 4,815 | 🐛 119 | 🌐 JavaScript | 📅 2025-11-17 - A streaming approach, speeds up web applications by providing parsed objects before the response completes.
...
* [oj](https://github.com/ohler55/oj) ⭐ 3,225 | 🐛 16 | 🌐 C | 📅 2026-09-06 - A fast JSON parser and Object marshaller as a Ruby gem.
...
* [SwiftyJSON](https://github.com/SwiftyJSON/SwiftyJSON) ⭐ 22,947 | 🐛 139 | 🌐 Swift | 📅 2026-08-18 - The better way to deal with data in Swift.
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 2 | 🌐 C | 📅 2026-09-09 - A lightweight featureful DSL for data modeling.
...
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,807 | 🐛 234 | 🌐 Go | 📅 2026-08-27 - A structured configuration language that is both human and machine friendly.
...
* [Awesome jq](https://github.com/fiatjaf/awesome-jq) ⭐ 977 | 🐛 6 | 📅 2026-08-17 - A curated list of awesome jq tools and resources.
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 1,005 | 🐛 14 | 🌐 Java | 📅 2026-09-09 - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,138 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-03 - Fast XML to JSON and vice versa javascript/JSON conversion.
...
* [JSON Editor](https://github.com/jdorn/json-editor) ⭐ 5,818 | 🐛 456 | 🌐 JavaScript | 📅 2018-04-18 - JSON Schema Based Editor. (jQuery)
...
* [JSON Schema + Faker](https://github.com/json-schema-faker/json-schema-faker) ⭐ 3,448 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-01 - Fake your schemas.
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 305 | 🐛 29 | 🌐 C++ | 📅 2026-09-09 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [z-schema](https://github.com/zaggino/z-schema) ⭐ 350 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-09 - validator written in JavaScript for NodeJS and Browsers.
...
* [JSON Schema for PHP](https://github.com/justinrainbow/json-schema) ⭐ 3,631 | 🐛 19 | 🌐 PHP | 📅 2026-09-09 - PHP implementation of JSON schema.
