...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 510,074 | 🐛 107 | 📅 2026-09-02 list.
...
* [JSONView](https://addons.mozilla.org/en-US/firefox/addon/jsonview/) ([github](https://github.com/bhollis/jsonview) ⭐ 1,726 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-26) - View JSON documents in the browser.
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,687 | 🐛 450 | 🌐 C | 📅 2026-09-19 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,807 | 🐛 16 | 🌐 Go | 📅 2026-09-24 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,774 | 🐛 24 | 🌐 Rust | 📅 2026-09-24 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,640 | 🐛 34 | 🌐 Go | 📅 2026-08-26 - A interactive terminal tool.
...
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,295 | 🐛 88 | 🌐 Python | 📅 2026-09-23 - A terminal spreadsheet-like tool for interactively exploring data.
...
* [logdy](https://github.com/logdyhq/logdy-core) ⭐ 2,298 | 🐛 37 | 🌐 Go | 📅 2025-08-25 - jq, tail, less, grep and awk merged together and available in a clean web UI.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,391 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-25 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
* [lowdb](https://github.com/typicode/lowdb) ⭐ 22,583 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-27 - Flat file database built on lodash API. (Javascript)
* [Kinto](https://github.com/Kinto/kinto) ⭐ 4,418 | 🐛 97 | 🌐 Python | 📅 2026-09-24 - A lightweight JSON storage service with synchronisation and sharing abilities.
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,675 | 🐛 100 | 🌐 C++ | 📅 2026-09-25 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,272 | 🐛 74 | 🌐 C++ | 📅 2026-09-24 - Parsing gigabytes of JSON per second.
* [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,128 | 🐛 796 | 🌐 C++ | 📅 2025-02-05 - A fast JSON parser/generator for C++ with both SAX/DOM style API
...
* [ojg](https://github.com/ohler55/ojg) ⭐ 955 | 🐛 1 | 🌐 Go | 📅 2026-09-24 - A collection of high performance JSON processing and generating tool.
...
* [oj](https://github.com/ohler55/oj) ⭐ 3,224 | 🐛 15 | 🌐 C | 📅 2026-09-10 - A fast JSON parser and Object marshaller as a Ruby gem.
...
* [jsoniter-scala](https://github.com/plokhotnyuk/jsoniter-scala) ⭐ 819 | 🐛 100 | 🌐 Scala | 📅 2026-09-23 - Scala macros for compile-time generation of ultra-fast JSON codecs.
...
* [HOCON](https://github.com/lightbend/config/blob/master/HOCON.md) ⭐ 6,314 | 🐛 248 | 🌐 Java | 📅 2026-09-23 - Human-Optimized Config Object Notation.
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,811 | 🐛 231 | 🌐 Go | 📅 2026-09-24 - A structured configuration language that is both human and machine friendly.
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 1,005 | 🐛 14 | 🌐 Java | 📅 2026-09-25 - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,140 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-14 - Fast XML to JSON and vice versa javascript/JSON conversion.
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,043 | 🐛 25 | 🌐 Go | 📅 2026-08-16 - Query and update data structures using selectors from the command line. Comparable to [jq](https://github.com/jqlang/jq) ⭐ 35,687 | 🐛 450 | 🌐 C | 📅 2026-09-19 / [yq](https://github.com/kislyuk/yq) ⭐ 2,986 | 🐛 22 | 🌐 Python | 📅 2026-09-19 but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 305 | 🐛 27 | 🌐 C++ | 📅 2026-09-24 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,840 | 🐛 381 | 🌐 TypeScript | 📅 2026-09-06 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [z-schema](https://github.com/zaggino/z-schema) ⭐ 350 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-24 - validator written in JavaScript for NodeJS and Browsers.
