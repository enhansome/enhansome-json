...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,834 | 🐛 106 | 📅 2026-09-02 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,564 | 🐛 109 | 📅 2026-06-19
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,595 | 🐛 480 | 🌐 C | 📅 2026-09-01 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,804 | 🐛 19 | 🌐 Go | 📅 2026-09-13 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,753 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
...
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,276 | 🐛 89 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet-like tool for interactively exploring data.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,675 | 🐛 41 | 🌐 Python | 📅 2026-09-10 - Converts the output of many CLI tools, file-types, and common strings into JSON
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,600 | 🐛 114 | 🌐 C++ | 📅 2026-09-14 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,249 | 🐛 136 | 🌐 C++ | 📅 2026-09-07 - Parsing gigabytes of JSON per second.
* [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,121 | 🐛 794 | 🌐 C++ | 📅 2025-02-05 - A fast JSON parser/generator for C++ with both SAX/DOM style API
* [ArduinoJson](https://github.com/bblanchon/ArduinoJson) ⭐ 7,213 | 🐛 16 | 🌐 C++ | 📅 2026-08-15 - An efficient library for embedded systems.
...
* [Gson](https://github.com/google/gson) ⭐ 24,236 | 🐛 323 | 🌐 Java | 📅 2026-09-13 - A Java library to convert JSON to Java objects and vice-versa.
...
* [simplejson](https://github.com/simplejson/simplejson) ⭐ 1,710 | 🐛 15 | 🌐 Python | 📅 2026-09-13 - A simple, fast, extensible encoder/decoder
...
* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,871 | 🐛 39 | 🌐 C | 📅 2026-09-08 - High performance parser and serializer in C.
...
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,806 | 🐛 234 | 🌐 Go | 📅 2026-09-11 - A structured configuration language that is both human and machine friendly.
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 1,005 | 🐛 14 | 🌐 Java | 📅 2026-09-14 - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,828 | 🐛 377 | 🌐 TypeScript | 📅 2026-09-06 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [JSON Schema for PHP](https://github.com/justinrainbow/json-schema) ⭐ 3,632 | 🐛 21 | 🌐 PHP | 📅 2026-09-09 - PHP implementation of JSON schema.
