...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,325 | 🐛 106 | 📅 2026-09-02 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,568 | 🐛 114 | 📅 2026-06-19
...
* [JSONView](https://addons.mozilla.org/en-US/firefox/addon/jsonview/) ([github](https://github.com/bhollis/jsonview) ⭐ 1,724 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-26) - View JSON documents in the browser.
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,649 | 🐛 450 | 🌐 C | 📅 2026-09-19 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,805 | 🐛 18 | 🌐 Go | 📅 2026-09-19 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,766 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,634 | 🐛 33 | 🌐 Go | 📅 2026-08-26 - A interactive terminal tool.
...
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,679 | 🐛 27 | 🌐 Python | 📅 2026-09-19 - Converts the output of many CLI tools, file-types, and common strings into JSON
* [jid](https://github.com/simeji/jid) ⭐ 7,180 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - Incremental Digger. Drill down JSON interactively by using filtering queries like jq.
...
* [logdy](https://github.com/logdyhq/logdy-core) ⭐ 2,294 | 🐛 37 | 🌐 Go | 📅 2025-08-25 - jq, tail, less, grep and awk merged together and available in a clean web UI.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,389 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-18 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,640 | 🐛 106 | 🌐 C++ | 📅 2026-09-16 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,265 | 🐛 141 | 🌐 C++ | 📅 2026-09-20 - Parsing gigabytes of JSON per second.
...
* [ArduinoJson](https://github.com/bblanchon/ArduinoJson) ⭐ 7,218 | 🐛 17 | 🌐 C++ | 📅 2026-08-15 - An efficient library for embedded systems.
...
* [dsl-json](https://github.com/ngs-doo/dsl-json) ⭐ 1,072 | 🐛 49 | 🌐 Java | 📅 2026-09-13 - A very fast streaming JSON library. Operates on byte arrays.
...
* [SwiftyJSON](https://github.com/SwiftyJSON/SwiftyJSON) ⭐ 22,943 | 🐛 139 | 🌐 Swift | 📅 2026-08-18 - The better way to deal with data in Swift.

* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,880 | 🐛 38 | 🌐 C | 📅 2026-09-08 - High performance parser and serializer in C.
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 2 | 🌐 C | 📅 2026-09-20 - A lightweight featureful DSL for data modeling.
...
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,618 | 🐛 7 | 📅 2026-09-15 - A minimal configuration file format that's easy to read due to obvious semantics.
...
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,809 | 🐛 234 | 🌐 Go | 📅 2026-09-18 - A structured configuration language that is both human and machine friendly.
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 1,005 | 🐛 14 | 🌐 Java | 📅 2026-09-21 - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,138 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-14 - Fast XML to JSON and vice versa javascript/JSON conversion.
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 305 | 🐛 27 | 🌐 C++ | 📅 2026-09-20 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [Awesome JSON Schema](https://github.com/sourcemeta/awesome-jsonschema) ⭐ 169 | 🐛 15 | 🌐 Handlebars | 📅 2026-08-29 - A curated list of awesome JSON Schema resources, tutorials, tools, and more.
...
* [jsonschema](https://github.com/python-jsonschema/jsonschema) ⭐ 4,985 | 🐛 53 | 🌐 Python | 📅 2026-09-15 - Python implementation of jsonschema.
