...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,444 | 🐛 99 | 📅 2026-06-30 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,561 | 🐛 75 | 📅 2026-06-19
...
* [JSONExport](https://github.com/Ahmed-Ali/JSONExport) ⭐ 4,807 | 🐛 54 | 🌐 Swift | 📅 2023-10-22 - convert a object to a class of one of the currently supported languages.
...
* [JSON Formatter](https://chromewebstore.google.com/detail/json-formatter/bcjindcccaagfpapjjmafapmmgkkhgoa) ([github](https://github.com/callumlocke/json-formatter) ⭐ 4,128 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-26) - Makes JSON easy to read. Open source.
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,450 | 🐛 472 | 🌐 C | 📅 2026-08-12 - A lightweight and flexible command-line JSON processor.
...
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,239 | 🐛 71 | 🌐 Python | 📅 2026-08-04 - A terminal spreadsheet-like tool for interactively exploring data.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,663 | 🐛 50 | 🌐 Python | 📅 2026-06-18 - Converts the output of many CLI tools, file-types, and common strings into JSON
* [jid](https://github.com/simeji/jid) ⭐ 7,132 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - Incremental Digger. Drill down JSON interactively by using filtering queries like jq.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,338 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-14 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
* [lowdb](https://github.com/typicode/lowdb) ⭐ 22,572 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-27 - Flat file database built on lodash API. (Javascript)
* [Kinto](https://github.com/Kinto/kinto) ⭐ 4,417 | 🐛 95 | 🌐 Python | 📅 2026-08-13 - A lightweight JSON storage service with synchronisation and sharing abilities.
...
* [EJDB](https://github.com/Softmotions/ejdb) ⭐ 1,477 | 🐛 35 | 🌐 C | 📅 2026-08-08 - Embedded JSON Database engine published under MIT license. (C)
...
* [countries](https://github.com/mledoze/countries) ⭐ 6,252 | 🐛 17 | 🌐 PHP | 📅 2026-07-20 - World countries.
...
* [jsondiffpatch](https://github.com/benjamine/jsondiffpatch) ⭐ 5,334 | 🐛 55 | 🌐 TypeScript | 📅 2026-05-14 - Diff & patch for JavaScript objects. (Javascript)
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,364 | 🐛 100 | 🌐 C++ | 📅 2026-08-13 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,148 | 🐛 135 | 🌐 C++ | 📅 2026-08-12 - Parsing gigabytes of JSON per second.
* [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,111 | 🐛 789 | 🌐 C++ | 📅 2025-02-05 - A fast JSON parser/generator for C++ with both SAX/DOM style API
* [ArduinoJson](https://github.com/bblanchon/ArduinoJson) ⭐ 7,204 | 🐛 17 | 🌐 C++ | 📅 2026-08-11 - An efficient library for embedded systems.
...
* [Gson](https://github.com/google/gson) ⭐ 24,233 | 🐛 341 | 🌐 Java | 📅 2026-08-11 - A Java library to convert JSON to Java objects and vice-versa.
...
* [JSON-java](https://github.com/stleary/JSON-java) ⭐ 4,718 | 🐛 23 | 🌐 Java | 📅 2026-07-31 - A reference implementation.
...
* [oj](https://github.com/ohler55/oj) ⭐ 3,225 | 🐛 13 | 🌐 C | 📅 2026-08-13 - A fast JSON parser and Object marshaller as a Ruby gem.
...
* [jsoniter-scala](https://github.com/plokhotnyuk/jsoniter-scala) ⭐ 819 | 🐛 98 | 🌐 Scala | 📅 2026-08-13 - Scala macros for compile-time generation of ultra-fast JSON codecs.
...
* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,839 | 🐛 39 | 🌐 C | 📅 2026-07-22 - High performance parser and serializer in C.

## Linters

* [jsonlint](https://github.com/zaach/jsonlint) ⭐ 1,991 | 🐛 83 | 🌐 JavaScript | 📅 2022-07-12 - Parser and validator with a CLI. (Javascript)
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 3 | 🌐 C | 📅 2026-08-13 - A lightweight featureful DSL for data modeling.
...
* [HOCON](https://github.com/lightbend/config/blob/master/HOCON.md) ⭐ 6,311 | 🐛 242 | 🌐 Java | 📅 2026-07-01 - Human-Optimized Config Object Notation.
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,803 | 🐛 236 | 🌐 Go | 📅 2026-08-13 - A structured configuration language that is both human and machine friendly.
...
* [rabl](https://github.com/nesquena/rabl) ⭐ 3,634 | 🐛 122 | 🌐 Ruby | 📅 2026-03-18 - General ruby templating with json, bson, xml, plist and msgpack support. (Ruby)
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 1,003 | 🐛 15 | 🌐 Java | 📅 2026-08-14 - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 293 | 🐛 27 | 🌐 C++ | 📅 2026-08-12 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,806 | 🐛 375 | 🌐 TypeScript | 📅 2026-05-12 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [z-schema](https://github.com/zaggino/z-schema) ⭐ 350 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-13 - validator written in JavaScript for NodeJS and Browsers.
...
* [JSON Schema for PHP](https://github.com/justinrainbow/json-schema) ⭐ 3,628 | 🐛 21 | 🌐 PHP | 📅 2026-07-24 - PHP implementation of JSON schema.
