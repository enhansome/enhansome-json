...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,223 | 🐛 105 | 📅 2026-08-21 list.

[![Links](https://github.com/burningtree/awesome-json/actions/workflows/links.yml/badge.svg)](https://github.com/burningtree/awesome-json/actions/workflows/links.yml) ⭐ 1,565 | 🐛 97 | 📅 2026-06-19
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,514 | 🐛 473 | 🌐 C | 📅 2026-08-23 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,796 | 🐛 18 | 🌐 Go | 📅 2026-08-23 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,735 | 🐛 22 | 🌐 Rust | 📅 2026-08-28 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,611 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - A interactive terminal tool.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,499 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - Convert a JSON file into discrete assignments that are greppable.
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,257 | 🐛 80 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet-like tool for interactively exploring data.
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,489 | 🐛 140 | 🌐 C++ | 📅 2026-08-28 - A C++11 header-only class.
* [simdjson](https://github.com/simdjson/simdjson) ⭐ 24,214 | 🐛 134 | 🌐 C++ | 📅 2026-08-27 - Parsing gigabytes of JSON per second.
* [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,119 | 🐛 790 | 🌐 C++ | 📅 2025-02-05 - A fast JSON parser/generator for C++ with both SAX/DOM style API
...
* [jsoniter-scala](https://github.com/plokhotnyuk/jsoniter-scala) ⭐ 819 | 🐛 99 | 🌐 Scala | 📅 2026-08-30 - Scala macros for compile-time generation of ultra-fast JSON codecs.
...
* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,853 | 🐛 41 | 🌐 C | 📅 2026-08-26 - High performance parser and serializer in C.
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 3 | 🌐 C | 📅 2026-08-29 - A lightweight featureful DSL for data modeling.
...
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,596 | 🐛 8 | 📅 2026-08-29 - A minimal configuration file format that's easy to read due to obvious semantics.
...
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,799 | 🐛 235 | 🌐 Go | 📅 2026-08-27 - A structured configuration language that is both human and machine friendly.
...
* [JSON Parsing Test Suite](https://github.com/nst/JSONTestSuite) ⭐ 1,164 | 🐛 53 | 🌐 C++ | 📅 2024-11-22 - A very complete test suite and validation framework.
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 1,004 | 🐛 14 | 🌐 Java | 📅 2026-08-27 - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 299 | 🐛 29 | 🌐 C++ | 📅 2026-08-27 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,818 | 🐛 376 | 🌐 TypeScript | 📅 2026-05-12 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [JSON Schema for PHP](https://github.com/justinrainbow/json-schema) ⭐ 3,630 | 🐛 20 | 🌐 PHP | 📅 2026-08-21 - PHP implementation of JSON schema.
