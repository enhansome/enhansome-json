...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,521 | 🐛 106 | 📅 2026-09-02 list.
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,591 | 🐛 480 | 🌐 C | 📅 2026-09-01 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,803 | 🐛 18 | 🌐 Go | 📅 2026-09-13 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,752 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,624 | 🐛 30 | 🌐 Go | 📅 2026-08-26 - A interactive terminal tool.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,517 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - Convert a JSON file into discrete assignments that are greppable.
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,274 | 🐛 90 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet-like tool for interactively exploring data.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,676 | 🐛 41 | 🌐 Python | 📅 2026-09-10 - Converts the output of many CLI tools, file-types, and common strings into JSON
* [jid](https://github.com/simeji/jid) ⭐ 7,140 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - Incremental Digger. Drill down JSON interactively by using filtering queries like jq.
...
* [oj](https://github.com/ohler55/ojg) ⭐ 954 | 🐛 1 | 🌐 Go | 📅 2026-09-12 - A fast and flexible command line JSON processor.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,377 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-13 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
* [lowdb](https://github.com/typicode/lowdb) ⭐ 22,578 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-27 - Flat file database built on lodash API. (Javascript)
* [Kinto](https://github.com/Kinto/kinto) ⭐ 4,417 | 🐛 96 | 🌐 Python | 📅 2026-09-10 - A lightweight JSON storage service with synchronisation and sharing abilities.
...
* [EJDB](https://github.com/Softmotions/ejdb) ⭐ 1,481 | 🐛 35 | 🌐 C | 📅 2026-09-10 - Embedded JSON Database engine published under MIT license. (C)
...
* [JSON-Patch](https://github.com/Starcounter-Jack/JSON-Patch) ⭐ 1,981 | 🐛 84 | 🌐 JavaScript | 📅 2025-10-23 - Lean and mean Javascript implementation of the JSON-Patch standard (RFC 6902). (Javascript)
...
* [JSON6](https://github.com/d3x0r/json6) ⭐ 241 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-12 - JSON for Humans (ES6).
...
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,366 | 🐛 133 | 🌐 C | 📅 2026-07-09 - A C library for encoding, decoding and manipulating data.
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,595 | 🐛 115 | 🌐 C++ | 📅 2026-09-12 - A C++11 header-only class.
...
* [ojg](https://github.com/ohler55/ojg) ⭐ 954 | 🐛 1 | 🌐 Go | 📅 2026-09-12 - A collection of high performance JSON processing and generating tool.
...
* [Gson](https://github.com/google/gson) ⭐ 24,236 | 🐛 337 | 🌐 Java | 📅 2026-09-13 - A Java library to convert JSON to Java objects and vice-versa.
...
* [dsl-json](https://github.com/ngs-doo/dsl-json) ⭐ 1,071 | 🐛 48 | 🌐 Java | 📅 2026-09-13 - A very fast streaming JSON library. Operates on byte arrays.
...
* [jsoniter-scala](https://github.com/plokhotnyuk/jsoniter-scala) ⭐ 819 | 🐛 98 | 🌐 Scala | 📅 2026-09-13 - Scala macros for compile-time generation of ultra-fast JSON codecs.
...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 2 | 🌐 C | 📅 2026-09-13 - A lightweight featureful DSL for data modeling.
...
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,613 | 🐛 6 | 📅 2026-09-11 - A minimal configuration file format that's easy to read due to obvious semantics.
...
* [JSONassert](https://github.com/skyscreamer/JSONassert) ⭐ 1,058 | 🐛 95 | 🌐 Java | 📅 2024-07-28 - Write JSON unit tests in less code. Great for testing REST interfaces. (Java)
...
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,138 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-10 - Fast XML to JSON and vice versa javascript/JSON conversion.
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 305 | 🐛 27 | 🌐 C++ | 📅 2026-09-11 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,827 | 🐛 377 | 🌐 TypeScript | 📅 2026-09-06 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [jsonschema](https://github.com/python-jsonschema/jsonschema) ⭐ 4,979 | 🐛 53 | 🌐 Python | 📅 2026-09-07 - Python implementation of jsonschema.
