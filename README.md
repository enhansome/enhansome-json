...
* [JSON Model](https://github.com/clairey-zx81/json-model) ⭐ 8 | 🐛 2 | 🌐 C | 📅 2026-09-26 - A lightweight featureful DSL for data modeling.
...
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,139 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-14 - Fast XML to JSON and vice versa javascript/JSON conversion.
...
* [json2json](https://github.com/joelvh/json2json) ⭐ 192 | 🐛 5 | 🌐 CoffeeScript | 📅 2021-07-26 - Transform (reformat) structures from one to another. (Javascript)
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 305 | 🐛 26 | 🌐 C++ | 📅 2026-09-25 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,840 | 🐛 380 | 🌐 TypeScript | 📅 2026-09-06 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
