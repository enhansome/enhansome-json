...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,542 | 🐛 106 | 📅 2026-09-02 list.
...
* [jq](https://github.com/jqlang/jq) ⭐ 35,675 | 🐛 451 | 🌐 C | 📅 2026-09-19 - A lightweight and flexible command-line JSON processor.
  * [gojq](https://github.com/itchyny/gojq) ⭐ 3,807 | 🐛 16 | 🌐 Go | 📅 2026-09-23 - Pure Go implementation of jq. A bit faster and more portable.
  * [jaq](https://github.com/01mf02/jaq) ⭐ 3,773 | 🐛 23 | 🌐 Rust | 📅 2026-08-28 - A jq clone focussed on correctness, speed, and simplicity. Written in Rust.
...
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,294 | 🐛 88 | 🌐 Python | 📅 2026-09-23 - A terminal spreadsheet-like tool for interactively exploring data.
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,684 | 🐛 33 | 🌐 Python | 📅 2026-09-23 - Converts the output of many CLI tools, file-types, and common strings into JSON
...
* [oj](https://github.com/ohler55/ojg) ⭐ 955 | 🐛 2 | 🌐 Go | 📅 2026-09-22 - A fast and flexible command line JSON processor.
...
* [JSON Server](https://github.com/typicode/json-server) ⭐ 75,721 | 🐛 721 | 🌐 JavaScript | 📅 2026-03-23 - Get a full fake REST API with zero coding in less than 30 seconds.
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,390 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-24 - Event-driven JSON-Database with JSON-Schema, mango-Query and CouchDB-sync. (Javascript)
* [lowdb](https://github.com/typicode/lowdb) ⭐ 22,582 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-27 - Flat file database built on lodash API. (Javascript)
* [Kinto](https://github.com/Kinto/kinto) ⭐ 4,419 | 🐛 96 | 🌐 Python | 📅 2026-09-19 - A lightweight JSON storage service with synchronisation and sharing abilities.
...
* [countries](https://github.com/mledoze/countries) ⭐ 6,264 | 🐛 17 | 🌐 PHP | 📅 2026-09-03 - World countries.
...
* [Nlohmann JSON](https://github.com/nlohmann/json) ⭐ 50,667 | 🐛 109 | 🌐 C++ | 📅 2026-09-24 - A C++11 header-only class.
...
* [ojg](https://github.com/ohler55/ojg) ⭐ 955 | 🐛 2 | 🌐 Go | 📅 2026-09-22 - A collection of high performance JSON processing and generating tool.
...
* [Gson](https://github.com/google/gson) ⭐ 24,235 | 🐛 327 | 🌐 Java | 📅 2026-09-16 - A Java library to convert JSON to Java objects and vice-versa.
...
* [simplejson](https://github.com/simplejson/simplejson) ⭐ 1,710 | 🐛 14 | 🌐 Python | 📅 2026-09-15 - A simple, fast, extensible encoder/decoder
...
* [oj](https://github.com/ohler55/oj) ⭐ 3,223 | 🐛 15 | 🌐 C | 📅 2026-09-10 - A fast JSON parser and Object marshaller as a Ruby gem.
...
* [jsoniter-scala](https://github.com/plokhotnyuk/jsoniter-scala) ⭐ 819 | 🐛 99 | 🌐 Scala | 📅 2026-09-23 - Scala macros for compile-time generation of ultra-fast JSON codecs.
...
* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,883 | 🐛 38 | 🌐 C | 📅 2026-09-08 - High performance parser and serializer in C.
...
* [TOML](https://github.com/toml-lang/toml) ⭐ 20,622 | 🐛 7 | 📅 2026-09-15 - A minimal configuration file format that's easy to read due to obvious semantics.
* [HOCON](https://github.com/lightbend/config/blob/master/HOCON.md) ⭐ 6,314 | 🐛 247 | 🌐 Java | 📅 2026-09-23 - Human-Optimized Config Object Notation.
* [HCL](https://github.com/hashicorp/hcl) ⭐ 5,809 | 🐛 231 | 🌐 Go | 📅 2026-09-23 - A structured configuration language that is both human and machine friendly.
...
* [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) ⭐ 3,139 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-14 - Fast XML to JSON and vice versa javascript/JSON conversion.
...
* [JSONC](https://github.com/tcorral/JSONC) ⭐ 651 | 🐛 22 | 🌐 JavaScript | 📅 2018-12-11 - JSON compressor and decompressor. (Javascript)
...
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,041 | 🐛 25 | 🌐 Go | 📅 2026-08-16 - Query and update data structures using selectors from the command line. Comparable to [jq](https://github.com/jqlang/jq) ⭐ 35,675 | 🐛 451 | 🌐 C | 📅 2026-09-19 / [yq](https://github.com/kislyuk/yq) ⭐ 2,983 | 🐛 22 | 🌐 Python | 📅 2026-09-19 but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [JSON Schema $Ref Parser](https://github.com/APIDevTools/json-schema-ref-parser) ⭐ 1,118 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20 - Parse, resolve, and dereference JSON Schema $ref pointers
...
* [JSON Schema CLI](https://github.com/intelligence-ai/jsonschema) ⭐ 305 | 🐛 28 | 🌐 C++ | 📅 2026-09-23 - Command-line interface for formatting, linting, testing, bundling, and validating schema files for local development and CI/CD pipelines.
...
* [ajv](https://github.com/ajv-validator/ajv) ⭐ 14,838 | 🐛 378 | 🌐 TypeScript | 📅 2026-09-06 - The fastest schema validator. Supports draft-04/06/07/2019-09/2020-12.
...
* [z-schema](https://github.com/zaggino/z-schema) ⭐ 350 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-23 - validator written in JavaScript for NodeJS and Browsers.
...
* [JSON Schema for PHP](https://github.com/justinrainbow/json-schema) ⭐ 3,630 | 🐛 25 | 🌐 PHP | 📅 2026-09-23 - PHP implementation of JSON schema.
* [JSON Guard](https://json-guard.thephpleague.com) - A validator for JSON Schema Draft 4.

**Python**

* [jsonschema](https://github.com/python-jsonschema/jsonschema) ⭐ 4,986 | 🐛 56 | 🌐 Python | 📅 2026-09-21 - Python implementation of jsonschema.
